import PrivGraph.community as comm
import networkx as nx
import time
import numpy as np
from PrivGraph.utils import *
...
def main_func(dataset_name='Chamelon',eps=[0.5,1,1.5,2,2.5,3,3.5],e1_r=1/3,e2_r=1/3,N=20,t=1.0,exp_num=10,save_csv=False):
    ...
    mat0_par = comm.best_partition(mat0_graph)
    ...
    mat0_mod = comm.modularity(mat0_par,mat0_graph)
    ...
    for ei in range(len(eps)):
        ...
        for exper in range(exp_num):
            ...
            mat2_par = comm.best_partition(mat2_graph)
            mat2_mod = comm.modularity(mat2_par,mat2_graph)
...
def main_in_pipeline(dataset_name='Chamelon',eps=1.5,e1_r=1/3,e2_r=1/3,N=20,t=1.0,exp_num=10,save_csv=False):


    t_begin = time.time()

    data_path = f'PrivGraph/data/{dataset_name}_preprocessed.txt'
    mat0,mid = get_mat(data_path)
    ...
    # mat2_graph2 = Graph.from_networkx(mat2_graph)
...
if __name__ == '__main__':
    ...
    dataset_name = 'bio-diseasome_preprocessed'

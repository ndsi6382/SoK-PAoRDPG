...
def main_vary_eps(dataset_name='Chamelon',epsilon=2,e1_r=1/3,e2_r=1/3,N=20,exp_num=10,save_csv=False):
    ...
    for exper in range(exp_num):
        print('-----------epsilon=%.1f,e1_r=%.1f,e2_r=%.1f,exper=%d/%d-------------'%(epsilon,e1_r,e2_r,exper+1,exp_num))


        t1 = time.time()

        # Community Initialization
        mat1_pvarr1 = community_init(mat0,mat0_graph,epsilon=e1,nr=N)

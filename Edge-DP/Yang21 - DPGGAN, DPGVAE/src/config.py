...
class DPGGAN_dblp2_ADADP:
    def __init__(self, epsilon=10.0):
        #self.layer1_dim = 32
        #self.layer2_dim = 16
        #self.dec1_dim = 16
        #self.dec2_dim = 32
...
def load_config(model_name, dataset_str, optimizer, epsilon=10.0):
    if model_name == 'GVAE' and 'dblp' in dataset_str:
        ...
        if model_name == "DPGVAE":
            return DPGVAE_dblp2_ADADP(epsilon=epsilon)    
        else:
            return DPGGAN_dblp2_ADADP(epsilon=epsilon)